      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#sobre">Sobre o Atom
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#">
				<img src="img/atom.png"  height="300px" width="500px" id="navbarResponsive">
			</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-6">
          <div class="well-middle">
            <div class="single-well" id="navbarResponsive">
                ...
                <h4 class="sec-head">Sobre o Atom</h4>
            
              <p>
                Somos um grupo de estudos do IFMG-Campus Bambuí que trabalhamos aprofundando 
                o conhecimento em robótica, juntamente com os professores de eletrônica. Nossos
                objetivos são:
              </p>
            </div>
          </div>
